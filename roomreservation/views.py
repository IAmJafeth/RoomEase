...
from .utils import get_busy_rooms, get_free_rooms, next_reservation, all_next_reservations_account
...
def homeSignedIn(request):
    ...
    args['reservations'] = all_next_reservations_account(args['account'])
    args['free_rooms'] = get_free_rooms()
    args['busy_rooms'] = get_busy_rooms()
    args['next_reservation'] = [next_reservation(room) for room in args['free_rooms']]
